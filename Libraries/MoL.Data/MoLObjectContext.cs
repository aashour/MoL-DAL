...
namespace MoL.Data
{
    public class MoLObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public MoLObjectContext()
        {
        ...
        public MoLObjectContext(string nameOrConnectionString)
            : base(nameOrConnectionString)
        {
            //((IObjectContextAdapter)this).ObjectContext.ContextOptions.LazyLoadingEnabled = true;
            //Database.SetInitializer<MoLObjectContext>(new CreateDatabaseIfNotExists<MoLObjectContext>());
            //((IObjectContextAdapter)this).ObjectContext.SavingChanges += ObjectContext_SavingChanges;
            Database.Log = msg => Trace.WriteLine(msg);
        }
